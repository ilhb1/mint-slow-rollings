...
def draw_binary_tree(achains, starting, size):
    sizex, sizey = size
    d = 1
...
def rec_draw(string, achains, coords, ancestor, angle, local_height, angle_dec):
    (x,y) = coords
    ...
    if string == "":
        ...
        pygame.draw.line(screen, LINE_COLOUR, ancestor, coords, 2)
    elif string[-1] == "0":
...
# antichain = ["00", "01", "1"]
antichain = ["000", "0010", "0011", "01", "1000", "1001", "101", "11"]
# draw_binary_tree(antichain, (SCREEN_WIDTH//2, 50))
# Update the screen
# pygame.display.flip()
...
running = True
while running:
    input_box = pygame.Rect(10, SCREEN_HEIGHT - 40, SCREEN_WIDTH - 20, 40)
    ...
    tree_size = (600,500)
    draw_binary_tree(antichain, (SCREEN_WIDTH//2, 50), tree_size)
